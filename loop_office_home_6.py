...
lr_list = [0.1]
momentum_list = [0.7, 0.8]  # 0.5, 0.7, 0.9
lambda_rec_list = [0.1]
lambda_mi_list = [0.001, 0.003, 0.005]  #
...
l2_list = [3e-4]  # 5e-5
tw_list = [5e-3]  # 5e-2
radius_list = [2.5]   # 5, 3.5

# best result
# lr_0.05_momentum_0.8_seed_1_lambda_rec_0.1w_lambda_mi_0.001_dropout_0.7_l2_0.0005

parser = argparse.ArgumentParser()
parser.add_argument("--src", default="Clipart", type=str)
parser.add_argument("--tgt", default="RealWorld", type=str)
...
command_list = []
command_format = "python ours_office_home_all_trick_2.py --src SOURCE --tgt TARGET " \
